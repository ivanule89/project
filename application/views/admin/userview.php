...
{
?>
<a class="btn btn-primary" onclick="window.location='<?=base_url();?>admin/userview/changestatus?uid=<?=$row->id_user;?>&r=active'" href="javascript:void(0)"><i class="icon-eye-open"></i> Active</a>
<?php
}else{
?>
<a class="btn btn-danger" onclick="window.location='<?=base_url();?>admin/userview/changestatus?uid=<?=$row->id_user;?>&r=deactive'" href="javascript:void(0)"><i class="icon-eye-close"></i> Deactive</a>
<?php } ?>
<a class="btn btn-warning" onclick="window.location='<?=base_url();?>admin/userview/delete?uid=<?=$row->id_user;?>'" href="javascript:void(0)"><i class="icon-trash"></i> Hapus</button></a>
</td>
</tr>
<?php }
?>
