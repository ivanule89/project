...
<body class="loginbody">
    ...
    <div class="loginwrapper">
        ...
        <h1 class="logintitle"><span class="iconfa-lock"></span> <?=get_option('site_app');?><span class="subtitle">Silahkan login terlebih dahulu</span></h1>
    ...
    <p class="animate6 bounceIn"><button class="btn btn-info btn-block">LOGIN</button></p>
